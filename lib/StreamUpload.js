...
class StreamUpload {
    ...
    upload() {
        ...
        // Read data, 4MB at time
        let chunkSize = 4096 * 1024 //4 * 1024 * 1024

        // Pipe sourceStream into a transform stream that makes chunks all of the same size
        this._sourceStream.pipe(StreamChunkify(chunkSize))
            .pipe(require('fs').createWriteStream('outtest.jpg'))
    }
     ...
     * @return {Promise} Promise containing the result of the initialization 
     */
